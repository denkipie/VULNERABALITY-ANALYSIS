...
After getting the user and password, type ``` ftp <TARGET IP> ``` in the attacker's terminal and type in the target's user and password, and boom, you have the access for the target's machine
